...
Migration and repair are combined into one V4 candidate document and one writer
...
event list without mutating live memory. Its persistence callback encodes a V4
...
Versionless V0 plus schema V1, V2, and V3 documents pass through the same event
validation and are immediately rewritten as V4. V2 adds
`compaction/summary`, V3 adds `context-budget/decision`, and V4 adds provider
usage anchors to assistant events. Surface provenance is derived before
