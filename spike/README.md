...
- [`006-minimal-harness-slice`](006-minimal-harness-slice/README.md) implements a replayable session, model, tool, and agent-loop vertical slice.
- [`007-runtime-architecture-decision`](007-runtime-architecture-decision/README.md) compares upstream, vendored, and locally maintained runtime ownership before production promotion.
