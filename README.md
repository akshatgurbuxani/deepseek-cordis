...
session discovery and resume, and provider routing. The
[`v1 qualification`](docs/coding-harness-v1.md) states supported limits, safe
defaults, and what is intentionally outside the product boundary.
